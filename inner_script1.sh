...
/usr/bin/sshpass -p $pass ssh -o StrictHostKeyChecking=no $netID@vcm-$v_m.vm.duke.edu curl -L https://raw.githubusercontent.com/TylerJang27/OpenVPNSetup/master/inner_script3.sh | /bin/bash -s $netID $v_m $pass
